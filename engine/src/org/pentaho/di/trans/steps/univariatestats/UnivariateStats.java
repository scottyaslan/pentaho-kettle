...
public class UnivariateStats extends BaseStep implements StepInterface {
  ...
  public boolean processRow( StepMetaInterface smi, StepDataInterface sdi ) throws KettleException {
    ...
    if ( first ) {
      ...
      List<FieldIndex> fi = new ArrayList<FieldIndex>( m_meta.getNumFieldsToProcess() );
      ...
      for ( int i = 0; i < m_meta.getNumFieldsToProcess(); i++ ) {
        ...
        if ( !Const.isEmpty( usmf.getSourceFieldName() ) ) {
          ...
          FieldIndex tempData =
              new FieldIndex( usmf, m_data.getInputRowMeta().indexOfValue( usmf.getSourceFieldName() ) );
          fi.add( tempData );
